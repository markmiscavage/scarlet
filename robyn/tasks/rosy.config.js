...
module.exports = function (grunt) {
	...
	var fs = require("fs"),
		cwd = process.cwd(),
		path = require("path"),
		output = path.join(cwd, "scarlet", "cms", "static"),
		source = path.join(cwd, "scarlet", "cms", "source"),
	...
	grunt.config.set("requirejs.admin", {
		options : {
			...
			mainConfigFile : path.join(source, "js", rosyConfig),
